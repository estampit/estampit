      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="text-2xl font-bold mb-4">MYSTAMP</div>
            <p className="text-gray-400 mb-6 max-w-md">
              La plataforma de fidelización digital más fácil de usar. 
              Ayudamos a negocios locales a aumentar las ventas recurrentes con sellos digitales.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="text-gray-400 text-sm">
              © {currentYear} MYSTAMP. Todos los derechos reservados.
            </div>
